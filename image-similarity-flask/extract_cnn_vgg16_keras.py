...
class VGGNet:
    def __init__(self):
        ...
        # self.model_densenet = DenseNet121(weights=self.weight, input_shape=(
        #     self.input_shape[0], self.input_shape[1], self.input_shape[2]), pooling=self.pooling, include_top=False)
        # self.model_inceptionv3 = InceptionV3(weights=self.weight, input_shape=(
        #     self.input_shape[0], self.input_shape[1], self.input_shape[2]), pooling=self.pooling, include_top=False)
        # self.model_xception = Xception(weights=self.weight, input_shape=(
        #     self.input_shape[0], self.input_shape[1], self.input_shape[2]), pooling=self.pooling, include_top=False)
        # self.model_inception_resnet_v2 = InceptionResNetV2(weights=self.weight, input_shape=(
        #     self.input_shape[0], self.input_shape[1], self.input_shape[2]), pooling=self.pooling, include_top=False)
        # self.model_nasnet = NASNetLarge(weights=self.weight, input_shape=(
        #     self.input_shape[0], self.input_shape[1], self.input_shape[2]), pooling=self.pooling, include_top=False)

        # self.model_vgg.predict(np.zeros((1, 224, 224, 3)))
        self.model_resnet.predict(np.zeros((1, 224, 224, 3)))
        # self.model_densenet.predict(np.zeros((1, 224, 224, 3)))
        # self.model_inceptionv3.predict(np.zeros((1, 299, 299, 3)))
        # self.model_xception.predict(np.zeros((1, 299, 299, 3)))
        # self.model_inception_resnet_v2.predict(np.zeros((1, 299, 299, 3)))
        # self.model_nasnet.predict(np.zeros((1, 331, 331, 3)))
    '''
    ...
    #     norm_feat = feat[0]/LA.norm(feat[0])
    #     return norm_feat
    # #提取inceptionv3最后一层卷积特征
    # def inceptionv3_extract_feat(self, img_path):
    #     img = image.load_img(img_path, target_size=(
    #         self.input_shape[0], self.input_shape[1]))
    #     img = image.img_to_array(img)
    #     img = np.expand_dims(img, axis=0)
    #     img = preprocess_input_inception_v3(img)
    #     feat = self.model_inceptionv3.predict(img)
    #     # print(feat.shape)
    #     norm_feat = feat[0]/LA.norm(feat[0])
    #     return norm_feat
    # #提取xception最后一层卷积特征
    ...
    #     norm_feat = feat[0]/LA.norm(feat[0])
    #     return norm_feat
    # #提取inception_resnet_v2最后一层卷积特征
    # def inception_resnet_v2_extract_feat(self, img_path):
    #     img = image.load_img(img_path, target_size=(
    #         self.input_shape[0], self.input_shape[1]))
    #     img = image.img_to_array(img)
    #     img = np.expand_dims(img, axis=0)
    #     img = preprocess_input_inception_resnet_v2(img)
    #     feat = self.model_inception_resnet_v2.predict(img)
    #     # print(feat.shape)
    #     norm_feat = feat[0]/LA.norm(feat[0])
    #     return norm_feat
    # #提取nasnet最后一层卷积特征
    # def nasnet_extract_feat(self, img_path):
    #     img = image.load_img(img_path, target_size=(
    #         self.input_shape[0], self.input_shape[1]))
    #     img = image.img_to_array(img)
    #     img = np.expand_dims(img, axis=0)
    #     img = preprocess_input_nasnet(img)
    #     feat = self.model_nasnet.predict(img)
    #     # print(feat.shape)
    #     norm_feat = feat[0]/LA.norm(feat[0])
    #     return norm_feat
