...
# )
base_model = VGG16(weights="imagenet", input_shape=target_shape + (3,), pooling="max", include_top=False)
...
base_cnn = Model(inputs=base_model.input, outputs=feat_vec)

# flatten = layers.Flatten()(base_cnn.output)
# dense1 = layers.Dense(512, activation="relu")(flatten)
# dense1 = layers.BatchNormalization()(dense1)
# dense2 = layers.Dense(256, activation="relu")(base_cnn.output)
# dense2 = layers.BatchNormalization()(dense2)
# output = layers.Dense(256)(dense2)

embedding = Model(base_cnn.input, base_cnn.output, name="Embedding")
embedding.summary(line_length=150, positions=[0.30, 0.60, 0.7, 1.])
...
distances = DistanceLayer()(
	...
	embedding(preprocess_input_vgg(anchor_input)),
	embedding(preprocess_input_vgg(positive_input)),
	embedding(preprocess_input_vgg(negative_input)),
)
